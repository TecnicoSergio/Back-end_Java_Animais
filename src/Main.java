...
//AGORA NO MAIN NÓS VAMOS DAR VIDA AQUILO QUE PROJETAMOS TRAREMOS A VIDA NOSSO PROJETO...
    public static void main(String[] args) {
        ...
        System.out.println("Quando falo pra meu cachorro fazer o numero 1 ele faz "
                + cachorro1.obediente( "xixi"));
        System.out.println("Quando falo pra meu cachorro fazer o numero 2 ele faz "
                + cachorro1.obediente( "coco"));
        ...
        System.out.println("Quando dou a bolinha pra meu gato ele "
                + gato1.interagir("brinca e pula corre "));
        System.out.println( "Quando dou alpiste e falo com meu passaro ele "
                + passaro1.interagir( "come e canta"));
